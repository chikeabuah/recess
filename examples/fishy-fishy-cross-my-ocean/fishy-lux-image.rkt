...
(define (draw-players guesses player-type)
  (define shape
    (cond
      [(eq? player-type "shark") (image:triangle 10 "solid" "violet")]
      [(eq? player-type "fish") (image:circle 10 "solid" "blue")]
      [(eq? player-type "seaweed") (image:square 10 "solid" "green")]))
  (map
